package com.test.functional.gui;

import static org.junit.Assert.*;

import org.junit.Test;
import org.openqa.selenium.By;
import com.test.functional.BaseSeleniumTestCase;
...
public class RegisterFT extends BaseSeleniumTestCase {
	...
	public void register() {
		...
		//跳转到登录页
		assertEquals("ssh4 test示例:登录页", s.getTitle());
		...
		//登陆成功
		assertEquals("ssh4 test示例:任务管理", s.getTitle());
