				...
				<div class="main-content">
					...
					<div class="page-content">
						<div class="page-header">
							...
							<script>
								function exportxls(){
									var url = "${ctx}/exportExcel?type=Academe";
									window.open(url);   
								}
							</script>
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					colNames:['院/系/所', '合计','男','女', '男', '女', '男', '女', '男', '女'],
					colModel:[
						{index:'groupName',name:'groupName',width:100,editable: false},
						{index:'sumall',name:'sumall',width:100,editable: false},
						{index:'summale',name:'summale',width:100,editable: false},
						{index:'sumfemale',name:'sumfemale',width:100,editable: false},
						{index:'sumbachelormale',name:'sumbachelormale',width:100,editable: false},
						{index:'sumbachelorfemale',name:'sumbachelorfemale',width:100,editable: false},
						{index:'summastermale',name:'summastermale',width:100,editable: false},
						{index:'summasterfemale',name:'summasterfemale',width:100,editable: false},
						{index:'sumdoctormale',name:'sumdoctormale',width:100,editable: false},  
						{index:'sumdoctorfemale',name:'sumdoctorfemale',width:100,editable: false},  
					], 
			...
			*/
				...
				*/
				...
				$(grid_selector).jqGrid('setGroupHeaders', {
					  ...
					  groupHeaders:[
							{startColumnName: 'sumall', numberOfColumns: 3, titleText: '合计'},
							{startColumnName: 'sumbachelormale', numberOfColumns: 2, titleText: '教职工'},
							{startColumnName: 'summastermale', numberOfColumns: 2, titleText: '家属'},
							{startColumnName: 'sumdoctormale', numberOfColumns: 2, titleText: '儿童'},
					  ],
				});
