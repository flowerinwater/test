...
<script>
		...
		function click(){
			$('#ttt').datagrid({  
			    url:'${ctx}/jsonccademerp',  
				toolbar:'#tb',
        		rownumbers:true,//行号  
				singleSelect:true,
				fit:true,
			    columns:[[ 
			        {field:'groupName',title:'院系所',width:100,rowspan:2},  
...
        		rownumbers:true,//行号  
				singleSelect:true,
			    columns:[[  
			        {field:'origin',title:'生源地',width:100,rowspan:2},  
			        {field:'grade',title:'年级',width:100,rowspan:2},  
			        {title:'合计',width:100,colspan:3},    
		...
		function exportxls(){
			var url = "${ctx}/exportExcel?type=Academe&academe="+$('#academe').val();
			window.open(url);   
		}
</script>
<style type="text/css">
