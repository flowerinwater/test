...
        		rownumbers:true,//行号  
			    ...
			    columns:[[
			        ...
			        {field:'sumall',title:'合计',width:100},  
			        {field:'summale',title:'男',width:100},  
			        {field:'sumfemale',title:'女',width:100}
				]]   
			});				 
		}		
...
        		rownumbers:true,//行号  
		...
		function exportxls(){
			var url = "${ctx}/exportExcel?type=Family&academe="+$('#academe').val();
			window.open(url);   
		}
</script>
<style type="text/css">
