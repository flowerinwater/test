				...
				<div class="main-content">
					...
					<div class="page-content">
						<div class="page-header">
							...
							<script>
								function exportxls(){
									var url = "${ctx}/exportExcel?type=Detained";
									window.open(url);   
								}
							</script>
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					colNames:['年级', '合计','男','女', '男', '女', '男', '女', '男', '女'],
					colModel:[
				...
				*/
				...
				$(grid_selector).jqGrid('setGroupHeaders', {
					  ...
					  groupHeaders:[
							...
							{startColumnName: 'sumbachelormale', numberOfColumns: 2, titleText: '本科生'},
							{startColumnName: 'summastermale', numberOfColumns: 2, titleText: '研究生'},
							{startColumnName: 'sumdoctormale', numberOfColumns: 2, titleText: '博士生'},
					  ],
				});
