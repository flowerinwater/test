		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					url:"${ctx}/jsonalertlendcard4?expiredays=10",
					contentType:'application/json;charset=UTF-8',
					datatype: "json",
					mtype:"post",
					
					height: 350,
					colNames:['id', '名称','借出日期','预计归还日期', '移动电话', '住宅电话','用途','备注'],
					colModel:[
						{name:'id',index:'id',width:100, sorttype:"int", editable: false},  
			      {name:'name',index:'name',width:100,editable:false},  
			      {name:'lendDate',index:'lendDate',width:100,editable:false},  
			      {name:'toReturnDate',index:'toReturnDate',width:100,editable:false},  
			      {name:'mobile',index:'mobile',width:100,editable:false},  
			      {name:'tel',index:'tel',width:100,editable:false},  
			      {name:'purpose',index:'purpose',width:100,editable:false},  
